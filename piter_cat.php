    ...
    <body>
      ...
      <div class="card" style="width: 40rem;">
        <div class="card-body" baclg>
          <div class="cent">
          <h3 class="card-title">Pitter Cat <a href="form.php"><button type="button" class="btn btn-info" align="center">HOME</button></a></h3>
          <p class="card-text">
            Rating: <i class="fa-solid fa-star"></i><br>
            <i class="fa-solid fa-location-dot"></i>
            <a>18A, Park Street, Park Street Area, Kolkata, West Bengal 700071</a><br>
            <i class="fa-solid fa-phone"></i>
            <a href="">03322172942</a><br>
            <i class="fa-solid fa-clock"></i>
            11.00-23.20<br>
            <i class="fa-solid fa-earth-asia"></i>
            website: <a href="https://tanyamunshi.com/">https://tanyamunshi.com/</a><br>
